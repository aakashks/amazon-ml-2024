...
```bash
vllm serve Qwen/Qwen2-VL-7B-Instruct --port 8080 --tensor-parallel-size 2 --dtype=half --max-model-len 3200 --trust-remote-code --limit-mm-per-prompt image=1 --enforce-eager --max_num_seqs=16
```
